...
<head>
  ...
  <meta content="Herlis" name="author">
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="{{ route('dashboard.index') }}" class="logo d-flex align-items-center">
        <img src="{{ $setting->logo ? asset('storage/' . $setting->logo): asset('niceadmin/img/logo.png') }}" alt="">
  ...
  <a href="#" class="back-to-top d-flex align-items-center justify-content-center"><i
      ...
      <div class="modal fade" id="deleteModal">
            ...
            <div class="modal-footer">
                 ...
                 <button type="submit"
                 class="btn btn-primary">Ya, hapus data</button>
            </div>
           </form>
         </div>
        </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="{{ route('login.logout') }}" type="button" class="btn btn-primary">Ya, saya ingin logout</a>
      </div>
    </div>
  </div>
</div>
