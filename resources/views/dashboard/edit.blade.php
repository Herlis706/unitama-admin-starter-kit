<x-app>
  ...
  <div class="col-md-6">
    ...
    <div class="alert alert-danger">{{ $message }}</div>
    @enderror
    <img src="{{ $user->avatar ? asset('storage/' . $user->avatar): asset('niceadmin/img/noprofil.png') }}" alt="avatar" class="w-50 rounded 
    mt-2" 
    id="preview">
  </div>
...
<div class="text-start">
    <a class="btn btn-warning" href="{{ route('dashboard.show') }}" 
