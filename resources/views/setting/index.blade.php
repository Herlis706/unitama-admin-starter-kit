<x-app>
  ...
  <div class="col-md-12">
    ...
    id="copyright" name="copyright" required value="{{ old('copyright',$setting->copyright) }}"> 
    @error('copyright')
    <div class="alert alert-danger">{{ $message }}</div>
    @enderror
  </div>
  ...
  <div class="col-md-3">
    ...
    <div class="alert alert-danger">{{ $message }}</div>
    @enderror
    <img src="{{ $setting->logo ? asset('storage/' . $setting->logo): asset('niceadmin/img/logo.png') }}" alt="logo" class="w-50 rounded 
    mt-2" 
    id="preview">
  </div>
