...
class SettingController extends Controller
{
   ...
   $validated = $request->validate([
    ...
    'logo'        => 'nullable|image|mimes:jpeg,png,jpg|max:1048', // Max ~1MB
], [
    ...
    'copyright.max     '   => 'Hak cipta (copyright) tidak boleh lebih dari :max karakter',
    ...
    if($request->file('logo')) {
        ...
        DB::rollBack();
        return to_route('setting.index')->withErrors('Data gagal disimpan');
    } 
    }
}
