...
class SettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
       Setting::create([
        ...
        'keywords' => 'dasboard admin, root admin laravel, sistem manajemen data, aplikasi backend, laravel admin panel, control panel website, manajemen user, app admin laravel',
       ]);
    }
}
